...
export default {
  ...
  "onBrokenLinks": "throw",
  "customFields": {
    "backendUrl": "https://hamzakhan123-physical-ai-textbook.hf.space"
  },
  "i18n": {
    "defaultLocale": "en",
    "locales": [
    ...
    [
      "classic",
      {
        "docs": {
          ...
          "editUrl": "https://github.com/hamza49699/physical-ai-textbook/tree/main"
        },
        "blog": {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "© 2025 Physical AI Textbook. Made with ❤️ for roboticists. Licensed under CC-BY-4.0."
    },
    "prism": {
      "theme": {
        "plain": {
